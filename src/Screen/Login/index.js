      ...
      <View style={styles.container}>
        <View>
          <Image
            ...
            source={require('../../assets/images/logoPotea.png')}
          />
          <Text style={styles.header}>Log in</Text>
          <Text style={styles.caption}>
            Let’s log in to your account and roll in to POTEA!
          </Text>
            ...
            <View>
              ...
              <View
                ...
                <TouchableOpacity onPress={togglePasswordVisibility}>
                  {passwordVisible ? (
                    <Eye variant="Linear" color={colors.green(0.6)} size={20} />
                  ) : (
                    <EyeSlash
                      variant="Linear"
        ...
        <View style={{gap: 10}}>
          <TouchableHighlight
            ...
            underlayColor={colors.green(0.9)}
            onPress={handleLogin}
